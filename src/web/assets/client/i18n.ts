...
const messages = {
  "en": {
    ...
    "exec.action.resolve-integration-conflicts": "Resolve Integration conflicts",
  ...
  "zh-CN": {
    ...
    "exec.action.resolve-integration-conflicts": "解决集成冲突",
